...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    # Iterate through all the people in the family:
    ...
    for person in people:
        ...
        # If person has no parents then use standard gene probability:
        ...
        # Multiply by the probability of the person with X genes having or not having the trait:
        person_prob *= PROBS['trait'][person_genes][person_trait]

        jointProb *= person_prob

    # Return the calculated joint probability of this possible scenario/situation
    return jointProb
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        # Calculate the total probability for each probabilty distribution
        ...
        probabilities[person]['gene'] = {genes: (
            prob / gene_prob_sum) for genes, prob in probabilities[person]['gene'].items()}
        probabilities[person]['trait'] = {trait: (
            prob / trait_prob_sum) for trait, prob in probabilities[person]['trait'].items()}
